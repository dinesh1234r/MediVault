...
function AddScanCenter() {
  ...
  const handlesubmit=async()=>{
    ...
    {
      console.log(DOB);
    const response=await axios.post('https://medivault.onrender.com/admin/postforscancenter',{Admin,gender,Doctor_name,DOB,photo,Email_Address,Current_Address,Qualifications,Specialization,Medical_License_Number,Medical_Council_Registration_Number,Years_of_experience},{
      headers:{
  ...
  >
    ...
    <VStack align={'baseline'} spacing={2} p={2}>
      ...
      <Input name='Doctor_name' placeholder='Doctor_name' value={values.Doctor_name} alignItems={'center'} maxW={'90%'} boxShadow={'md'} onChange={(e)=>handlechange(e)} ml={'5%'} bg='white'/>
        ...
        <FormLabel>Enter Photo</FormLabel>
        <HStack>
